...
private static int contadorId = 1;
    ...
    private void ajustarTela() {
        ...
        tabelaPacientes.setRowHeight(28);
        tabelaPacientes.getTableHeader().setPreferredSize(new java.awt.Dimension(0, 30));
    ...
    public void adicionarPacienteNaTabela(Paciente p) {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
      TelaCadastroPacientes tela = new TelaCadastroPacientes(this);
