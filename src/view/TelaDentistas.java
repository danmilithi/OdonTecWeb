...
private static int contadorId = 1;
    ...
    private void ajustarTela() {
        ...
        tabelaDentistas.setRowHeight(28);
        tabelaDentistas.getTableHeader().setPreferredSize(new java.awt.Dimension(0, 30));
    ...
    public void adicionarDentistaNaTabela(Dentista d) {
        DefaultTableModel model = (DefaultTableModel) tabelaDentistas.getModel();
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        new TelaCadastroDentistas(this).setVisible(true);
